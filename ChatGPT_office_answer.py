...
with st.container():
    for chat in st.session_state.chat_history:
        st.markdown(f'''
            ...
            <div style="background:#DCF8C6; padding:10px; border-radius:15px; max-width:75%; margin-bottom:1px;">
                {chat["question"]}
        ...
        st.markdown(f'''
            ...
            <div style="background:#F1F0F0; padding:10px 15px; border-radius:15px; max-width:75%; margin-left:auto; margin-bottom:1px;">
                {chat["answer"]}
            </div>''', unsafe_allow_html=True)
        st.markdown(f'''
